      ...
      body: SingleChildScrollView(
        child: Column(children: <Widget>[
          Container(
            ...
            height: 100,
            child: Image.asset(ImageHelper.wrapAssets("app.png"),width: 50,height: 50),
          ),
          ...
          GestureDetector(
              ...
              child:Row(
                children: <Widget>[
                  ...
                  Expanded(child: Container(
                    margin: EdgeInsets.only(right: 10),
                    alignment: Alignment.centerRight,
                    child: Image.asset(ImageHelper.wrapAssets("right_arrow.png"),width: 18,height: 18),
                  )
                  )
                ],
              ),
            ...
            onTap: (){
              NavigatorUtil.goWebPage(context, "https://admin.xigyu.com/Agreement", "用户协议");
            },
          ),
